...
One creates an array the other does not.
...
global, explicit, implicit, new bindng.

5. Why do we need super() in an extended class?
used in conjunction with 'extends' inorder to extent a constructor attributes and methods
